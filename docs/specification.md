...
| F008    | 経理用案件一覧     | 全案件の一覧（経理確認用）        | 経理担当者・管理者 |
| F009    | 案件確認・完了処理 | 案件の確認と完了処理              | 経理担当者・管理者 |
| F010    | Slack 通知         | 担当者への Slack 通知             | 経理担当者・管理者 |
| F011    | ユーザー管理       | ユーザーの権限設定                | 管理者             |
| F012    | マスタデータ管理   | 選択肢項目の管理                  | 管理者             |
...
2. 確認ダイアログを表示
3. 確認後、案件の is_fixed フラグを true に設定
4. 申請完了メッセージを表示
